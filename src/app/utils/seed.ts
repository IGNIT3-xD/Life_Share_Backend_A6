...
export const seedSuperAdmin = async () => {
    try {
        ...
        if (!name || !email || !password) {
            throw new AppError(400, "Super Admin Name , Email, Password Missing In Env File!!!");
        }
...
export const seedTesterAdmin = async () => {
    try {
        ...
        if (!name || !email || !password) {
            throw new AppError(400, "Tester Admin Name , Email, Password Missing In Env File!!!");
        }
...
export const seedTesterDonor = async () => {
    try {
        ...
        if (!name || !email || !password) {
            throw new AppError(400, "Tester Donor Name , Email, Password Missing In Env File!!!");
        }
...
export const seedTesterHospital = async () => {
    try {
        ...
        if (!name || !email || !password) {
            throw new AppError(400, "Tester Hospital Name , Email, Password Missing In Env File!!!");
        }
