...
const createServiceValidate = z.object({
	...
	service_category: z.enum(ServiceCategory, "Service category is not valid"),
	...
	availability: z.string().min(3, "Availability time is required"),
});
...
const updateServiceValidate = z.object({
	...
	availability: z.string().min(3, "Availability time is required").optional(),
});
